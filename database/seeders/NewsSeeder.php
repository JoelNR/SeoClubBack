...
class NewsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        News::create([
            ...
            'content' => 'Arqueros de toda Canarias han competido en el Campeonato de España IBERDROLA al Aire Libre 2021-2022. Nos encanta ver a tantos arqueros canarios compitiendo fuera a nivel nacional. 
Dentro de los resultados obtenidos, tenemos a Alberto López Pérez y Francisca Teresa Amador que consiguen plata en equipo tradicional mixto. Jorge Jose López, Jorge Julio Pérez y Nelson Eduardo Torres, bronce en equipo masculino Compuesto. Nelson Eduardo Torres, bronce en arco compuesto individual. Y por último, Carlos Luis Pey, plata Recurvo 50+. 
Un excelente resultado de la expedición Canaria, felicidades a todos los participantes. Agradecer el apoyo de la Federación Canaria para lograr la participación.',
            'date' => '2022-09-01',
...
¡Enhorabuena a todo el equipo! Más que merecido premio después de la temporada que llevamos y el esfuerzo día a día.',
        ...
        News::create([
            ...
            'content' => 'El pasado mes, nuestro arquero Alexander Fleitas Hernández, realizó la prueba de ascenso para los 70 metros y la completó con éxito, uniendose al grupo de ocho arqueros que dispone el club en este nivel. 
¡Felicidades a Alex, a disfrutar esos 70m!',
            'date' => '2022-12-20',
